...
export default {
  ...
  pages: {
    ...
    niche: {
      ...
      storage_rows: 'Hileras (Uds)',
      storage_rows_placeholder: 'Cantidad de hileras del nicho',
      description: 'Descripción',
    ...
    casket: {
      ...
      people_in_casket: 'Restos cinerarios pertenecientes a',
      person_in_casket: 'Restos cinerarios pertenecientes a',
      people: 'Persona/s',
    ...
    user: {
      ...
      password_repeat_placeholder: 'Repetir contraseña del usuario',
    ...
    reservation: {
      ...
      end_date_placeholder: 'Fecha de fin de la reserva',
      ...
      date_info_text_1_update: 'Reserva realizada desde',
      date_info_text_2: 'hasta',
      reservation_time_validation: 'Introduzca un número mayor que 0',
      description: 'Anotaciones',
      description_placeholder: 'Anotaciones sobre la reserva',
      urn: 'Urna',
      deposit: 'Depósito de la reserva',
      reservation_urn: 'Urna asociada a la reserva',
      person: 'Titular / Solicitante',
      reservation_person: 'Titular / Persona que solicita la reserva',
      ...
      resume_person_selected: 'Titular / Solicitante',
    ...
    deposit: {
      ...
      start_date: 'Fecha del depósito',
      end_date: 'Fecha de fin',
      start_date_placeholder: 'Fecha en la que se realizó el depósito',
      end_date_placeholder: 'Fecha en la que se trasladó el depósito',
      date_info_text_1: 'El depósito será realizada desde',
      date_info_text_2: 'hasta',
      description: 'Anotaciones',
      description_placeholder: 'Anotaciones sobre el depósito',
    ...
    relocation: {
      ...
      details_title: 'Detalles de la reubicación',
      add_relocation: 'Añadir reubicación',
      reservation_active: 'Reserva a reubicar',
      casket_id: 'Cofre a reubicar',
      date: 'Fecha de la reubicación',
      date_placeholder: 'Fecha de la reubicación de la reserva',
      building_id: 'Edificio destino',
      room_id: 'Sala destino',
      row_id: 'Fila destino',
      niche_id: 'Nicho destino',
      urn_id: 'Urna destino',
      description: 'Anotaciones',
      description_placeholder: 'Anotaciones sobre la reubicación',
      end_date: 'Fecha de extracción',
      end_date_placeholder: 'Fecha de extracción del cofre',
      casket_relocated: 'Cofre reubicado',

      reservation_associated: 'Reserva asociada',
      reservation_selected: 'Reserva seleccionada',
      casket_selected: 'Cofre seleccionado',
      resume_urn_selected: 'Urna destino',
      resume_relocation_title: 'Resumen de la reubicación',

      no_data: 'No se han encontrado reubicacións.',
      modal_create_title: 'Añadir reubicación',
      modal_edit_title: 'Editar reubicación',
      modal_delete_title: 'Eliminar reubicación',
      modal_delete_text1: '¿Está seguro que quiere eliminar la reubicación',
      successfully_created: 'La reubicación ha sido creada correctamente.',
      successfully_edited: 'La reubicación ha sido editada correctamente.',
      successfully_deleted: 'La reubicación ha sido eliminada correctamente.',
      delete_error: 'La reubicación no ha sido encontrada.'
    },
    map: {
